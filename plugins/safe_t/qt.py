...
from electrumg.plugins import hook, DeviceMgr
from electrumg.util import PrintError, UserCancelled, bh2u
from electrumg.wallet import Wallet, Standard_Wallet
    ...
    def request_safe_t_init_settings(self, wizard, method, device):
        ...
        if method in [TIM_NEW, TIM_RECOVER]:
            ...
            if method == TIM_MNEMONIC:
                ...
                def set_enabled():
                    from electrumg.keystore import is_xprv
