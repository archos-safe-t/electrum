...
from electrum_bcd.util import bfh, bh2u, versiontuple, UserCancelled, to_bytes
from electrum_bcd.bitcoin import (b58_address_to_hash160, xpub_from_pubkey, deserialize_xpub,
                              TYPE_ADDRESS, TYPE_SCRIPT, is_address)
from electrum_bcd import constants, util
from electrum_bcd.i18n import _
from electrum_bcd.plugins import BasePlugin, Device
from electrum_bcd.transaction import deserialize, Transaction
from electrum_bcd.keystore import Hardware_KeyStore, is_xpubkey, parse_xpubkey, xtype_from_derivation
from electrum_bcd.base_wizard import ScriptTypeNotSupported
...
class SafeTPlugin(HW_PluginBase):
    ...
    def get_coin_name(self):
        return "BCD Test" if constants.net.TESTNET else "Bitcoin Diamond"
