...
exe_standalone = EXE(
    ...
    a.binaries,
    a.datas, 
    name=os.path.join('build\\pyi.win32\\electron-cash', cmdline_name + ".exe"),
    debug=False,
    strip=None,
    upx=False,
...
exe_portable = EXE(
    ...
    name=os.path.join('build\\pyi.win32\\electron-cash', cmdline_name + "-portable.exe"),
    debug=False,
    strip=None,
    upx=False,
    icon=home+'icons/electron.ico',
...
coll = COLLECT(
    ...
    icon=home+'icons/electron.ico',
    console=False,
    name=os.path.join('dist', 'electron-cash'))
