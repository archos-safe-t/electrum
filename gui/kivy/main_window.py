...
import electrumg
from electrumg.bitcoin import TYPE_ADDRESS
from electrumg import WalletStorage, Wallet
from electrumg_gui.kivy.i18n import _
from electrumg.paymentrequest import InvoiceStore
from electrumg.util import profiler, InvalidPassword
from electrumg.plugins import run_hook
from electrumg.util import format_satoshis, format_satoshis_plain
from electrumg.paymentrequest import PR_UNPAID, PR_PAID, PR_UNKNOWN, PR_EXPIRED
...
#Factory.register('InstallWizard', module='electrumg_gui.kivy.uix.dialogs.installwizard')
#Factory.register('InfoBubble', module='electrumg_gui.kivy.uix.dialogs')
#Factory.register('OutputList', module='electrumg_gui.kivy.uix.dialogs')
#Factory.register('OutputItem', module='electrumg_gui.kivy.uix.dialogs')
...
Factory.register('TabbedCarousel', module='electrumg_gui.kivy.uix.screens')
...
from electrumg.util import base_units
...
class ElectrumWindow(App):
    ...
    def choose_server_dialog(self, popup):
        ...
        protocol = 's'
        def cb2(host):
            from electrumg import constants
    ...
    def on_qr(self, data):
        from electrumg.bitcoin import base_decode, is_address
        data = data.strip()
        if is_address(data):
            self.set_URI(data)
            return
        ...
        from electrumg.transaction import Transaction
        from electrumg.util import bh2u
        try:
    ...
    def show_pr_details(self, req, status, is_invoice):
        from electrumg.util import format_time
    ...
    def init_ui(self):
        ...
        Factory.register('AnimatedPopup',
                         module='electrumg_gui.kivy.uix.dialogs')
        Factory.register('QRCodeWidget',
                         module='electrumg_gui.kivy.uix.qrcodewidget')
