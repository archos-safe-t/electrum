...
import electrum_bcd
from electrum_bcd.bitcoin import TYPE_ADDRESS
from electrum_bcd import WalletStorage, Wallet
from electrum_bcd_gui.kivy.i18n import _
from electrum_bcd.paymentrequest import InvoiceStore
from electrum_bcd.util import profiler, InvalidPassword
from electrum_bcd.plugins import run_hook
from electrum_bcd.util import format_satoshis, format_satoshis_plain
from electrum_bcd.paymentrequest import PR_UNPAID, PR_PAID, PR_UNKNOWN, PR_EXPIRED
...
#Factory.register('InstallWizard', module='electrum_bcd_gui.kivy.uix.dialogs.installwizard')
#Factory.register('InfoBubble', module='electrum_bcd_gui.kivy.uix.dialogs')
#Factory.register('OutputList', module='electrum_bcd_gui.kivy.uix.dialogs')
#Factory.register('OutputItem', module='electrum_bcd_gui.kivy.uix.dialogs')
...
# the data
Cache.register('electrum_bcd_widgets', timeout=0)
...
Factory.register('TabbedCarousel', module='electrum_bcd_gui.kivy.uix.screens')
...
from electrum_bcd.util import base_units, NoDynamicFeeEstimates
...
class ElectrumWindow(App):
    ...
    def on_qr(self, data):
        from electrum_bcd.bitcoin import base_decode, is_address
        data = data.strip()
        if is_address(data):
            self.set_URI(data)
            return
        ...
        from electrum_bcd.transaction import Transaction
        from electrum_bcd.util import bh2u
        try:
    ...
    def show_pr_details(self, req, status, is_invoice):
        from electrum_bcd.util import format_time
    ...
    def load_wallet_by_name(self, path, ask_if_wizard=False):
        ...
        if wallet:
            ...
            Logger.debug('Electrum-BCD: Wallet not found or action needed. Launching install wizard')
    ...
    def init_ui(self):
        ...
        Factory.register('AnimatedPopup',
                         module='electrum_bcd_gui.kivy.uix.dialogs')
        Factory.register('QRCodeWidget',
                         module='electrum_bcd_gui.kivy.uix.qrcodewidget')

        # preload widgets. Remove this if you want to load the widgets on demand
        #Cache.append('electrum_bcd_widgets', 'AnimatedPopup', Factory.AnimatedPopup())
        #Cache.append('electrum_bcd_widgets', 'QRCodeWidget', Factory.QRCodeWidget())
