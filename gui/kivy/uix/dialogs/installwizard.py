...
from electrum_bcd.base_wizard import BaseWizard
from electrum_bcd.util import is_valid_email
...
class RestoreSeedDialog(WizardDialog):
    ...
    def __init__(self, wizard, **kwargs):
        ...
        from electrum_bcd.old_mnemonic import words as old_wordlist
