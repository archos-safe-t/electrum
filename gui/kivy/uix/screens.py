...
from electrumg.util import profiler, parse_URI, format_time, InvalidPassword, NotEnoughFunds, Fiat
from electrumg import bitcoin
from electrumg.util import timestamp_to_datetime
...
class SendScreen(CScreen):
    ...
    def set_URI(self, text):
        import electrumg
        try:
            uri = electrumg.util.parse_URI(text, self.app.on_pr)
        except:
    ...
    def do_save(self):
        ...
        from electrumg.paymentrequest import make_unsigned_request, PaymentRequest
...
class ReceiveScreen(CScreen):
    ...
    def get_URI(self):
        from electrumg.util import create_URI
